...
PERIODS <- c('ACS_DRY')
VARIABLES <- c('ACS_DRY_BLUE_qmo_median', 'ACS_DRY_GREEN_qmo_median', 'ACS_DRY_RED_qmo_median', 'ACS_DRY_NIR_qmo_median', 'ACS_DRY_SWIR1_qmo_median', 'ACS_DRY_SWIR2_qmo_median', 'ACS_DRY_TIR1_qmo_median', 'ACS_DRY_TIR2_qmo_median', 'ACS_DRY_EVI2_qmo_median', 'ACS_DRY_NDWI_qmo_median', 'ACS_DRY_CAI_qmo_median', 'ACS_DRY_BLUE_qmo_stdDev', 'ACS_DRY_GREEN_qmo_stdDev', 'ACS_DRY_RED_qmo_stdDev', 'ACS_DRY_NIR_qmo_stdDev', 'ACS_DRY_SWIR1_qmo_stdDev', 'ACS_DRY_SWIR2_qmo_stdDev', 'ACS_DRY_TIR1_qmo_stdDev', 'ACS_DRY_TIR2_qmo_stdDev', 'ACS_DRY_EVI2_qmo_stdDev', 'ACS_DRY_NDWI_qmo_stdDev', 'ACS_DRY_CAI_qmo_stdDev')
IGNORE_VARIABLES <- c()

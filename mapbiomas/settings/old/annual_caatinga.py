...
GENERATION_VARIABLES = [
    ...
    'AC_WET_RED_max', 'AC_WET_SWIR1_max', 'AC_WET_SWIR2_max',
    'AC_WET_TIR1_max', 'AC_WET_EVI2_max', 'AC_WET_NDWI_max', 'AC_WET_CAI_max',
    'AC_WET_GREEN_min', 'AC_WET_SWIR1_min', 'AC_WET_EVI2_min',
    'AC_WET_NDWI_min', 'AC_WET_CAI_min',
    'AC_WET_GREEN_median', 'AC_WET_RED_median', 'AC_WET_SWIR1_median',
    'AC_WET_SWIR2_median', 'AC_WET_NDWI_median', 'AC_WET_CAI_median',
    'AC_WET_RED_stdDev', 'AC_WET_SWIR1_stdDev', 'AC_WET_SWIR2_stdDev',
    'AC_WET_TIR1_stdDev', 'AC_WET_EVI2_stdDev', 'AC_WET_NDWI_stdDev',
    'AC_WET_CAI_stdDev',

    'AC_DRY_NDWI_qmo', 'AC_DRY_CAI_qmo',
    'AC_DRY_RED_max', 'AC_DRY_SWIR1_max', 'AC_DRY_SWIR2_max',
    'AC_DRY_NDWI_max', 'AC_DRY_CAI_max',
    'AC_DRY_RED_min', 'AC_DRY_SWIR2_min', 'AC_DRY_EVI2_min', 'AC_DRY_NDWI_min',
    'AC_DRY_CAI_min',
    'AC_DRY_GREEN_median', 'AC_DRY_RED_median', 'AC_DRY_SWIR1_median',
    'AC_DRY_SWIR2_median', 'AC_DRY_EVI2_median', 'AC_DRY_NDWI_median',
    'AC_DRY_SWIR1_stdDev', 'AC_DRY_NDWI_stdDev']
GENERATION_EXTRA_VARIABLES = ['ANNUAL_NIR_cei', 'ANNUAL_EVI2_cei',
                              'ANNUAL_NDWI_cei']
...
CLASSIFICATION_TRAIN = 'users/agrosatelite_mapbiomas/COLECAO_4/REFERENCE_MAPS/ANNUAL/USED'
...
EXPORT_ASSET = ''
EXPORT_DIRECTORY = 'mapbiomas_c4/classification/annual/caatinga/2019'
EXPORT_MAX_TASKS = 3
EXPORT_INTERVAL = 30
EXPORT_MAX_ERRORS = 1
EXPORT_BUFFER = -4200
...
EXPORT_SCALES = {
    100: [Band.TIR1],
    10000: [Band.GREEN, Band.RED, Band.NIR, Band.SWIR1, Band.SWIR2, Band.EVI2,
            Band.NDWI, Band.CAI],
}

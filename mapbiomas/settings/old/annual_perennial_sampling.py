...
CLASSIFICATION_TRAIN = 'users/agrosatelite_mapbiomas/COLECAO_5/REFERENCE_MAPS/AGRICULTURE/agricultura_2016'
CLASSIFICATION_TREES = 100
CLASSIFICATION_POINTS = 5000
CLASSIFICATION_BUFFER = 100000

# ********** SAMPLING SETTINGS *******************
SAMPLER_CLASS = processors.AnnualPerennialSampler
SAMPLING_MASK = 'projects/mapbiomas-workspace/TRANSVERSAIS/AGRICULTURA4-FT'
...
EXPORT_BUCKET = ''
EXPORT_ASSET = ''
EXPORT_DIRECTORY = 'ANNUAL_PERENNIAL_SAMPLES'
EXPORT_MAX_TASKS = 1
EXPORT_INTERVAL = 30
EXPORT_MAX_ERRORS = 2
EXPORT_BUFFER = -4200

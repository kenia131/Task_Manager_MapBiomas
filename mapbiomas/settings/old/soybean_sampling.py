...
FEATURE_WRS_SELECTED = {
    'AND': {'SB_WRS': 1},
    'OR': {'CERRADO': 1, 'AMAZONIA': 1}
}
FEATURE_WRS = 'PATHROW'
FEATURE_WRS_FILTER = []

# exclude WRS: 224076, 222076, 221076, 221077, 220077, 225076, 224075
...
CLASSIFICATION_TRAIN = 'users/agrosatelite_mapbiomas/COLECAO_5/REFERENCE_MAPS/ANNUAL_CROPS/collection'
CLASSIFICATION_TREES = 100
CLASSIFICATION_POINTS = 10000
CLASSIFICATION_BUFFER = 100000

# ********** SAMPLING SETTINGS *******************
SAMPLER_CLASS = processors.SoybeanSampler

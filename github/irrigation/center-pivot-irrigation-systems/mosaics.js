...
var startDate = ui.Textbox('yyyy-mm-dd', '2020-01-01');
var endDate = ui.Textbox('yyyy-mm-dd', '2020-12-31');
...
Map.onClick(function(coordinates){
  ...
  var l8Collection = ee.ImageCollection(filterLandsatCollection("LANDSAT/LC08/C01/T1_TOA", roi, "2013-03-01", "2025-01-01", cloudCoverValue));
